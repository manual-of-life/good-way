...
while(true){
if((i <= self__.level)){
var links_13463 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13463[i]));
} else {
x__$2.forward.push((((i < links_13463.length))?(links_13463[i]):null));
}

if((i < links_13463.length)){
(links_13463[i] = x__$2);
} else {
links_13463.push(x__$2);
}
...
var i_13479 = (0);
while(true){
if((i_13479 <= self__.level)){
var links_13480 = (update[i_13479]).forward;
if((x__$1 === (((i_13479 < links_13480.length))?(links_13480[i_13479]):null))){
(links_13480[i_13479] = (x__$1.forward[i_13479]));

var G__13481 = (i_13479 + (1));
i_13479 = G__13481;
continue;
} else {
var G__13482 = (i_13479 + (1));
i_13479 = G__13482;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__13507 = nx;
var G__13508 = (level__$1 - (1));
x = G__13507;
level__$1 = G__13508;
continue;
} else {
var G__13510 = x;
var G__13511 = (level__$1 - (1));
x = G__13510;
level__$1 = G__13511;
continue;
}
